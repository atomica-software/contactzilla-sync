...
interface StartupPlugin {
    ...
    /**
     * Runs synchronously during [com.atomicasoftware.contactzillasync.App.onCreate]. Use only for tasks that must be completed before
    ...
    /**
     * Runs asynchronously after [com.atomicasoftware.contactzillasync.App.onCreate]. Use for tasks that can be run in the background.
     *
