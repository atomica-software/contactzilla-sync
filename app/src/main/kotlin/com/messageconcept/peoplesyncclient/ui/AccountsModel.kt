...
import com.atomicasoftware.contactzillasync.ui.intro.IntroPage
...
import com.atomicasoftware.contactzillasync.util.packageChangedFlow
...
class AccountsModel @AssistedInject constructor(
    ...
    val showAppIntro: Flow<Boolean> = flow<Boolean> {
        // Intro screens completely disabled - always return false
        logger.fine("Intro screens completely disabled")
        emit(false)
