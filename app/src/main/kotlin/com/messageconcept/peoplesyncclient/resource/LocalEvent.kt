...
import com.messageconcept.peoplesyncclient.resource.LocalEvent.Companion.numInstances
...
class LocalEvent: AndroidEvent, LocalResource<Event> {
    ...
    companion object {
        init {
            ICalendar.prodId = ProdId("PeopleSync/${BuildConfig.VERSION_NAME} ical4j/" + ical4jVersion)
        }
